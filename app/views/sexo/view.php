...
<div class="container">
    <div class="d-flex justify-content-between mb-4">
        ...
        <div>
            <a href="/public/index.php?controller=sexo&action=edit&id=<?= $this->sexo->id_sexo ?>" class="btn btn-warning">
    ...
    <div class="card">
        ...
        <div class="card-footer text-end">
            <form action="/public/index.php?controller=sexo&action=delete&id=<?= $this->sexo->id_sexo ?>" method="POST" style="display: inline;">
