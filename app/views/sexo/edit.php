...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?= BASE_URL ?>index.php?controller=sexo&action=update" method="POST">
                ...
                <a href="<?= BASE_URL ?>index.php?controller=sexo&action=index" class="btn btn-secondary">Cancelar</a>
            </form>
        </div>
    </div>
</div>
