...
<form action="<?= BASE_URL ?>index.php?controller=persona&action=store" method="POST">
    ...
    <a href="<?= BASE_URL ?>index.php?controller=persona&action=index" class="btn btn-secondary">Cancelar</a>
</form>