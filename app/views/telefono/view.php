...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?= BASE_URL ?>index.php?controller=telefono&action=edit&id=<?= $this->telefono->id_telefono ?>" class="btn btn-sm btn-warning">
                <i class="bi bi-pencil"></i> Editar
            </a>
            <a href="<?= BASE_URL ?>index.php?controller=persona&action=view&id=<?= $this->telefono->id_persona ?>" class="btn btn-sm btn-secondary">
    ...
    <div class="card-footer text-end">
        <form action="<?= BASE_URL ?>index.php?controller=telefono&action=delete&id=<?= $this->telefono->id_telefono ?>" method="POST" style="display: inline;">
